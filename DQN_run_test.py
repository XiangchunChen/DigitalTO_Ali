...
def run_network(env, agent, task_num, transaction_model, reward_model, s_dim):
    ...
    torch.save(transaction_model.state_dict(), transaction_name)
    now = "rewardTO"
    reward_name = "DTmodels/"+now+".pth"
    # Save the trained model
    torch.save(reward_model.state_dict(), reward_name)
...
if __name__ == "__main__":
    ...
    task_file_path = ali_data+"task_info_20.csv"
    task_pre_path = ali_data+"task_pre_20.csv"
